...
export default function Backpack() {
  ...
  return (
    <>
      <div className="w-full h-max from-zinc-900 to-purple-950 bg-gradient-to-br pt-[122px] lg:pt-0 pb-12">
        <Header />

        <div className="lg:w-[90vw] min-h-screen flex flex-col lg:flex-row">
          <div className="max-h-screen w-full flex items-center relative">
            ...
            <div className="flex flex-col justify-evenly h-[40vh] w-[90vw] lg:w-[45vw] pl-[4vw] pr-10 py-5 lg:py-10 lg:pr-12 bg-purple-950 rounded-r-full shadow-sm shadow-black">
              <div className="text-2xl text-gray-50 lg:text-left">
              ...
              <div className="lg:text-left text-2xl text-gray-50 w-full sm:w-4/5 lg:w-4/5 mt-6">
          ...
          <div className="w-[90vw] min-h-[60vh] flex flex-col px-6 lg:pl-16 mx-auto pt-12 lg:pt-[175px] relative">
            ...
            <div className="absolute w-6 h-6 bg-purple-800 bg-opacity-70 -top-6 lg:top-52 lg:-right-3 right-3 hue-rotate-30 -rotate-12" />
